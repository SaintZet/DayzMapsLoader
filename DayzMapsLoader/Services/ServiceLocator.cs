...
internal class ServiceLocator
{
    ...
    {
        var saveSettings = new ImageSaver(directory, mapProvider.ToString(), mapType.ToString(), mapZoom.ToString());

        _imagesDownloader = new ImageDownloader(mapProvider, mapType, mapZoom, saveSettings);
    ...
    public void ExecuteCommand(CommandType command) => (command switch
    {
        ...
        CommandType.GetMap => _imagesDownloader.DownloadMap,
        CommandType.GetMapInParts => _imagesDownloader.DownloadMapInParts,
        CommandType.MergePartsMap => _imagesDownloader.MergePartsMap,
