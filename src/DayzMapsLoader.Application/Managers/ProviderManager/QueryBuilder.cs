...
internal class QueryBuilder
{
    ...
    internal string GetQuery(int i, int j) => _mapProviderName switch
    {
        MapProviderName.xam => string.Format(_queryTemplate, _mapName, _version, _type, _zoom, i.ToString(), j.ToString(), _extension),
        MapProviderName.ginfo => string.Format(_queryTemplate, _mapName, _type, _version, _zoom, i.ToString(), j.ToString(), _extension),
        _ => throw new NotImplementedException("RequestsHub.Domain.Services.QueryBuilder.GetQuery: Add new provider in this method!"),
    };
